...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    private void btnCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargarActionPerformed
        ...
        controladora.modificarMascota(masco, nombreMascota, tipoAnimal, raza, observaciones,
                color, alergico, atencionEspecial, nombreDuenio, celular, direccion);
        
        //mensaje
        mostrarMensaje("Operación exitosa", "Info", "Mascota Actualizada"); 
    ...
    private void cargarDatos(int num_cliente) {
        ...
        txtTipoAnimal.setText(masco.getTipoAnimal());
